    ...
    for (const file of stagedFiles) {
      ...
      if (sensitive) {
        findings.push({
          ...
          file: file.path,
          line: 1,
          message: `${file.path} is a ${sensitive} and should never be committed. CommitGuard can remove it from this commit and add it to .gitignore — the file stays on your disk.`,
