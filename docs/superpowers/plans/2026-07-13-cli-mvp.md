...
- [ ] **Step 9: Create `bin/vibeguard.js`**
...
- [ ] **Step 4: Create `src/orchestrator.ts`**
...
- [ ] **Step 3: Create `src/scanners/secrets.ts`**
...
- [ ] **Step 3: Create `src/scanners/owasp.ts`**
...
- [ ] **Step 3: Create `src/scanners/deps.ts`**
...
- [ ] **Step 3: Create `src/fix/fixers.ts`**
...
- [ ] **Step 3: Create `src/fix/interactive.ts`**
...
- [ ] **Step 5: Wire it into the CLI — modify `src/cli.ts`**
